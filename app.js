document.addEventListener("DOMContentLoaded", async () => {
  ...
  const timeElapse = (date) => {
    ...
    const result = ` <span class="digit">${days}</span> nap <span class="digit">${hours}</span> óra <span class="digit">${minutes}</span> perc <span class="digit">${seconds}</span> másodperce`;
